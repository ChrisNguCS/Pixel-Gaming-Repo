...
<title>Valorant Tournaments</title>
<div class="banner">
    <div class="headerContainer">
        <img src="../images/valorant.jpg" alt="" class="header">
    ...
    <div class="titleCard"  style="width: 600px; top: 200px; left: 150px;">
        <img src="../images/valorant.jpg" alt="" class="thumbnail" style="height:auto; width: 150px;">
    ...
    <div>
        <div class="container">
            ...
            <?php
                ...
                $sql = "SELECT * FROM games WHERE gameName='Valorant';";
