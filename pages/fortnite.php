...
<title>Fortnite Tournaments</title>
<div class="banner">
    ...
    <div class="titleCard"  style="width: 600px; top: 200px; left: 150px;">
        <img src="../images/fortnite.jpg" alt="" class="thumbnail" style="height:auto; width: 150px;">
    ...
    <div>
        <div class="container">
            ...
            <?php
                ...
                $sql = "SELECT * FROM games WHERE gameName='Fortnite';";
